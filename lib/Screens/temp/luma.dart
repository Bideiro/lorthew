...
import 'package:lorthew/Screens/profile_screen_t.dart';
import 'package:lorthew/Screens/schedule_screen_t.dart';
...
class UsersList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('TutorData').snapshots(),
      ...
      child: Card(
        ...
        child: ListTile(
          leading: CircleAvatar(
            child: Text((data['fname'][0] + data['lname'][0]).toUpperCase()),
          ),
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //Build Userlist except User that is logged in
