...
class RegisterScreenForPupil extends StatefulWidget {
  const RegisterScreenForPupil({Key? key}) : super(key: key);

  @override
  State<RegisterScreenForPupil> createState() => _RegisterScreenForPupilState();
}

class _RegisterScreenForPupilState extends State<RegisterScreenForPupil> {
