...
class RegisterScreenForTutor extends StatefulWidget {
  const RegisterScreenForTutor({Key? key}) : super(key: key);

  @override
  State<RegisterScreenForTutor> createState() => _RegisterScreenForTutorState();
}

class _RegisterScreenForTutorState extends State<RegisterScreenForTutor> {
  final List<String> items = ['Tutor', 'Pupil'];
  String? selectedValue = "Tutor";
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Text(
                          'Register as a Tutor with your email and password:',
                          style: TextStyle(
                            fontSize: 16,
                          ),
                        ),
